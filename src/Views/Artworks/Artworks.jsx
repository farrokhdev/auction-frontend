...
function Artworks() {
  ...
  const handleClose = (value) => {
    if (params?.auctions__status.indexOf(status(value)) > -1) {
      handleAuctionStatus(
        params?.auctions__status?.filter((item) => item !== status(value))
      );
    }
    ...
    if (params?.auctions__type.indexOf(convertTypeEN(value)) > -1) {
      handleSetType(
        params?.auctions__type?.filter((item) => item !== convertTypeEN(value))
      );
    }
                              ...
                              <div className="artwork-category">
                                ...
                                <span className="">
                                  {item?.latest_auction?.type ? (
                                    ...
                                    <span className="category-icon text-secondary">
                                      بدون حراجی
                                    </span>
                                  )}
                                </span>
                                        ...
                                        {({
                                          ...
                                          >
                                            ...
                                            <span className="d-inline-block">
                                              ...
                                              <span className="d-inline-block text-danger mx-2">
                                                {" "}
                                                و{" "}
                                              </span>
                                              <span className="d-inline-block text-danger">
