              ...
              {/* <tr>
                ...
                <td>
                  {artwork?.creation_date
                    ? momentJalaali(artwork?.creation_date).format(
                        `jYYYY/jMM/jDD`
                      )
                    : ""}
                </td>
                    ...
                    <span
                      className={classnames("category-icon", {
                        ...
                        "online-icon":
                          artwork?.latest_auction?.type === "ONLINE",
                        "timed-icon":
                          artwork?.latest_auction?.type === "PERIODIC",
                        "firstoffer-icon":
                          artwork?.latest_auction?.type === "HIDDEN",
                        "secondoffer-icon":
                          artwork?.latest_auction?.type === "SECOND_HIDDEN",
                      })}
                    >
                ...
                <div className="block-footer row">
                  <div className="col-sm-5">
                    <div className="auction-calender date-show">
                      <div
                        className={classnames("auction-date", {
                          "d-none":
                      ...
                      <div
                        className={classnames("auction-time", {
                          "d-none":
                            artwork?.latest_auction?.status === "CLOSED",
                        })}
                      >
                  ...
                  <div className="col-sm-7 textalign-left">
                    ...
                    <button
                      className={classnames("btn btn-gray  mx-2", {
                    ...
                    <button
                      className={classnames("btn", "btn-main", "join", {
          ...
          <div className="vartical-tab">
            ...
            <div className="tab-content" id="vt-1Content">
              ...
              >
                ...
                <p>
                  {convertTypeAuctionToPersian(
                    artwork?.latest_auction?.payment_method
                  )}
                </p>
              </div>
              <div
