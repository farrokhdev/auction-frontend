...
function OneAuction(props) {
  ...
  const scrollToRef = (ref) =>
    myRef.current.scrollIntoView(0, ref.current.offsetTop);
    ...
    axios
      ...
      .then((resp) => {
        if (resp.data.code === 200) {
          ...
          axios
            .get(
              `${BASE_URL}/account/home-auction/${resp.data.data.result?.house?.id}/`
            )
            .then((res) => {
                ...
                <div className="bg-shadow bl-shadow10">
                  <div className="auction-detail">
                    <div className="block-head row">
                      <div className="col-6">{convertToEn(Auction.type)}</div>
                      ...
                      {Auction?.status !== "CLOSED" ? (
                        <>
                          ...
                          <div className="auction-time">
                            <span className="start-time ps-1">
                              {" "}
                              {moment(Auction?.start_time, "YYYY-MM-DD HH:mm")
                                .locale("fa")
                                .format("HH")}
                            </span>
                    ...
                    <div className="auction-moreinfo">
                      <a href="#" className="d-info category">
                        <h6 className="default">
                          {Auction.category ? Auction.category[0]?.title : ""}
                        </h6>
                      </a>
                      <Link
                        to={`/house-acutions/${HouseDetail?.id}`}
                        className="d-info gallery"
                      >
                        <h6 className="default">
                          {Auction?.house?.home_auction_name}
                        </h6>
                      </Link>
                    </div>
                      ...
                      {Auction?.status !== "CLOSED" ? (
                        ...
                        <>
                          ...
                          <div className="auction-total-price">
                            ...
                            <span>
                              {numberWithCommas(Auction?.products_total_price)}{" "}
                              تومان
                            </span>
                          </div>
                        </>
