...
function CardArtworkLatestSection() {
    return (
        
        <div className="artwork-block  mx-3">
        <div className="artwork-img ">
            <img src="https://picsum.photos/seed/picsum/317/280" width="317" height="280" alt="" className="img-fluid w-100"/>
