            ...
            <main className="innercontent" id="all-auctions">
                <div className="container innercontainer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 ">
                            <div class="ah-block">
                                <div class="ah-block-info logo">
                                    <div class="bg-shadow tl-shadow10">
                                        <img src="img/logo-3.png" width="159" height="159" alt="arthibition gallery"/>
                                    </div>
                                </div>
                                <div class="ah-block-info ">
                                    <div class="ah-block-title">
                                        <h5 class="default">Visual art</h5>
                                    ...
                                    <div class="d-sm-flex d-lg-block justify-content-sm-between">
                                        ...
                                        <div class="info-location bg-shadow tl-shadow10">
