                    ...
                    <div className="col-12">
                        <div className="form-check sm-mrgt35">
                            ...
                            <label className="form-check-label" htmlFor="checkbox41">
                                Validation by Artibition
                                <span className="form-check-txt">Enable this option if you want the site to be responsible for the authentication process
                                </span>
                            </label>
                        </div>
                    </div>
                ...
                {!admin_confirmation ? <div className="row">
                    <div className="col-12">
                        <div className="form-check sm-mrgt35">
                            ...
                            <label className="form-check-label" htmlFor="checkbox42">
                                Send invitation
                                <span className="form-check-txt">You can upload a list of buyers by activating the option to send an invitation </span>
                            </label>
                        </div>
                    ...
                    {is_send_invitation ? <div className="col-12 mb-4" dir="ltr">
                        <div className="text-end">
                            <a href={ExampleExel} download={true} className="text-secondary m-0"> Sample  <DownloadOutlined /></a>
                            <Upload {...props} className="btn-outline-pink" style={{ color: "#e6007e" }}
                                ...
                                <Button className="btn-outline-pink border-0 m-0" style={{ color: "#e6007e" }}
                                    icon={<UploadOutlined />}>Upload list</Button>
                    ...
                    <div className="col-12">
                        <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="checkbox44">
                                Other
                                <span className="form-check-txt">Enable this option if you want the site to be responsible for the authentication process</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="col-12">
                        <div className="button-group">
                            ...
                            <Button className="btn-default" htmlType="submit"
                                disabled={!validations_auction?.length && !admin_confirmation && !is_send_invitation}>Continue</Button>
                        </div>
                    </div>
                </div>
            </Form>
