...
const Products = (props) => {
    ...
    useEffect(() => {
        ...
        let start = moment(start_time).format("YYYY-MM-DD")
        let end = moment(end_time).format("YYYY-MM-DD")
        let list_date = {}
        ...
        for (this_date; this_date <= end;) {
            ...
            this_date = moment(this_date, "YYYY-MM-DD").add(1, 'days').format("YYYY-MM-DD")
        }
                ...
                <Collapse defaultActiveKey={['1']}
                          ...
                          }} accordion>
                    {
                        Object.keys(productsDate).map((item, i) => <Panel header={
                            ...
                            <div className="d-flex align-items-center justify-content-between">
                                <span>{moment(item, "YYYY-MM-DD").locale('en').format("YYYY  MMMM DD")}</span>
                                <div>
                            ...
                            <div className="row mt-3">
                                {
                                    ...
                                    className="col-12 col-md-6 col-lg-4 col-xl-3 ">
                                            <div className="mb-3">
                                                ...
                                                >
                                                    <Meta
                                                        title={productsDate?.[item][prd]?.artwork_title_en}
                                                        description={<div className="pt-2">
                                                            <div
                                                                ...
                                                                /><small className="pe-2">{productsDate?.[item][prd]?.latest_auction?.currency}</small></div>
